...
powershell -ExecutionPolicy Bypass -File "Skills/dump-analyze/scripts/analyze-dump.ps1" \
    -DumpFile "C:\path\to\dumps\app_20260411_003649_424.dmp" \
    -SymbolPath "C:\path\to\symbols"
```
...
```bash
powershell -ExecutionPolicy Bypass -File "Skills/dump-analyze/scripts/analyze-dump.ps1" \
    -DumpFolder "C:\path\to\dumps" \
    -SymbolPath "C:\path\to\symbols" \
    -OutputFile "C:\path\to\dumps\analysis_report.txt"
```
...
| `-SymbolPath` | No | Symbol search path (default: alongside the crashed binary) |
...
```
================================================================================
  Dump: app_20260411_003649_424.dmp
================================================================================
...
powershell -ExecutionPolicy Bypass -File "Skills/dump-analyze/scripts/analyze-dump.ps1" \
    -DumpFolder "C:\path\to\dumps" \
    -OutputFile "C:\path\to\dumps\full_analysis.txt"
```
