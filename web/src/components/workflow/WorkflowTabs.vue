...
type TabId = 'list' | 'canvas' | 'history' | 'yaml' | 'agentGen'
...
const { workflows, runs, editingDirty, drafts } = storeToRefs(store)
...
<template>
  <div class="tabs">
    ...
    >
      ...
      <span
        v-if="tab.id === 'agentGen' && counts.agentGen"
        class="draft-dot"
        title="有待应用草稿"
      />
    </button>
